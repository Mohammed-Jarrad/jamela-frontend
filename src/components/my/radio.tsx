...
const Radio: React.ForwardRefRenderFunction<HTMLInputElement, RadioProps> = ({ className, fill, ...props }, ref) => {
    return (
        <RadioContainer>
            <RadioInput {...props} ref={ref} />
            <RadioCheck className={className}>
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <path
                            ...
                            fill={fill ? fill : 'hsl(var(--primary))'}
