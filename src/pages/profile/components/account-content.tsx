                ...
                <CardContent>
                    ...
                    >
                        <Flex
                            $items="end"
                            $gap="lg"
                            className="col-span-full my-2 max-md:justify-center"
                        >
                            <img
                                src={
                                    formData.file
                                        ? URL.createObjectURL(formData.file)
                                        : currentUser.image?.secure_url
                                }
                        ...
                        <Flex
                            $items="center"
                            className="col-span-full mt-6 max-sm:text-xs max-md:!flex-col"
                        >
                            <Select
                            ...
                            <Button
                                className="ml-auto w-full md:w-40 text-base"
                                type="submit"
                                disabled={isPending}
                            >
