...
const PasswordController = () => {
    ...
    return (
        <Card>
            <CardHeader className="mx-auto max-w-[320px] p-6 md:px-0">
                <CardTitle>Password</CardTitle>
            </CardHeader>
            <CardContent>
                <form className="grid-cols- mx-auto grid max-w-[320px] gap-3" onSubmit={handleUpdatePassword}>
                    <CustomInput
                        label="Old Password"
                        name="oldPassword"
                        placeholder="******"
                    ...
                    <CustomInput
                        ...
                        className="data-[invalid=true]:ring-red-500 data-[invalid=true]:text-red-500"
                        onChange={handleChange}
                        required
                    />
